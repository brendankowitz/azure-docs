...
Composite search parameters can also be used to filter multiple component code value quantities with an OR operater. For example, to express the query to find diastolic blood pressure greater than 90 OR systolic blood pressure greater than 140:
